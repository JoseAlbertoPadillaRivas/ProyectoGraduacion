...
namespace ProyectoDeGraduacion.BaseDatos
{
    ...
    public partial class ProyectoGraduacionEntities : DbContext
    {
        ...
        public virtual ObjectResult<ObtenerCalificaciones_Result> ObtenerCalificaciones()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ObtenerCalificaciones_Result>("ObtenerCalificaciones");
        }
    
        public virtual int RegistrarCita1(Nullable<int> idPaciente, Nullable<int> idSede, Nullable<System.DateTime> fecha, Nullable<System.TimeSpan> hora)
        {
            var idPacienteParameter = idPaciente.HasValue ?
                new ObjectParameter("idPaciente", idPaciente) :
                new ObjectParameter("idPaciente", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("RegistrarCita1", idPacienteParameter, idSedeParameter, fechaParameter, horaParameter);
        }
    
        public virtual int GenerarCalificacion1(Nullable<int> calificaciones, Nullable<int> idPaciente, string opinion, Nullable<int> idServicio, Nullable<System.DateTime> fecha)
        {
            var calificacionesParameter = calificaciones.HasValue ?
                new ObjectParameter("Calificaciones", calificaciones) :
                new ObjectParameter("Calificaciones", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("GenerarCalificacion1", calificacionesParameter, idPacienteParameter, opinionParameter, idServicioParameter, fechaParameter);
        }
    
        public virtual int EliminarCalificacion(Nullable<int> idCalificaciones)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("EliminarCalificacion", idCalificacionesParameter);
        }
    
        public virtual ObjectResult<Nullable<int>> ObtenerPromedioCalificaciones()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("ObtenerPromedioCalificaciones");
        }
    
        public virtual ObjectResult<Nullable<int>> ObtenerPromedioCalificaciones1()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("ObtenerPromedioCalificaciones1");
        }
    }
}
